...
- `Progression-Lab-<version>-iOS-Simulator.app.zip` — an iOS Simulator app.
...
The current simulator bundle contains both arm64 and x86_64 simulator architectures.
...
- Tested minimum deployment target: iOS 15.0
- Branded app icon and launch artwork use the Progression Lab launcher asset.
