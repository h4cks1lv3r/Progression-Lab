...
class WorkoutShareCardGenerator {
  ...
  static void _drawAmbientGlow(Canvas canvas) {
    canvas.drawCircle(
      ...
      430,
      Paint()
        ..shader = ui.Gradient.radial(const Offset(930, 250), 430, [
          BrandColors.purple.withValues(alpha: .23),
          Colors.transparent,
        ]),
    );
    canvas.drawCircle(
      ...
      390,
      Paint()
        ..shader = ui.Gradient.radial(const Offset(70, 1510), 390, [
          BrandColors.cyan.withValues(alpha: .12),
          Colors.transparent,
        ]),
    );
  }
  ...
  static void _drawPill(
    ...
    final rect = Rect.fromLTWH(origin.dx, origin.dy, painter.width + 42, 52);
    canvas.drawRRect(
